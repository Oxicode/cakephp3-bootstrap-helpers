...
class PaginatorHelper extends \Cake\View\Helper\PaginatorHelper {
    ...
    protected $_defaultConfig = [
        ...
        'templates' => [
            ...
            'nextDisabled' => '<li class="page-item disabled"><a class="page-link" tabindex="-1">{{text}}</a></li>',
            'prevActive' => '<li class="page-item"><a href="{{url}}" class="page-link">{{text}}</a></li>',
            'prevDisabled' => '<li class="page-item disabled"><a class="page-link" tabindex="-1">{{text}}</a></li>',
